            ...
            <div class="dataBlock">
                ...
                <input type="hidden" name="token" value="${token}"/>	
                    <div class="input-group input-group-lg div">
                        ...
                        <input type="password" class="form-control" placeholder="請輸入密碼" name="password" value=""
                        		required autofocus id="password">
                    </div>
                    <div class="input-group flex-nowrap input-group-lg div">
                        <span class="input-group-text">密碼確認</span>
                        <input type="password" class="form-control" placeholder="請再次輸入密碼" name="confirmPassword" value=""
                        		required autofocus oninput="checkPasswordMatch(this)">
                    </div>
                    <div class="btnBlock gap-2 col-6 mx-auto container div">
                            <input class="button btn btn-success" type="submit"
                                style="width:200px;height:40px;" value="送出">
                    </div>
                </form>
            </div>
        </div>
